    ...
    useEffect(() => {
        if (!authLoading) {
            ...
            if (productId) {
                ...
                // Use onSnapshot for real-time updates of views and sales
                const unsubscribe = onSnapshot(productDocRef, (docSnap) => {
                    if (docSnap.exists() && docSnap.data().artisanId === user.uid) {
                        setProduct({ id: docSnap.id, ...docSnap.data() });
                    } else {
                        // Redirect if the product doesn't exist or belong to the user
                ...
                <div className="md:col-span-2">
                    <Card>
                         <CardHeader>
                            ...
                            <CardDescription>
                                This data is updated in real-time. Use it to generate an AI analysis.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                           ...
                           {!analysis && !aiLoading && (
                                <div className="text-center p-8 border-2 border-dashed rounded-lg">
                                    ...
                                    <p className="text-muted-foreground mt-2 mb-4">
                                        Generate an AI-powered strategic report to get concrete tips on pricing, marketing, photography, and more.
                                    </p>
                           ...
                           {analysis && (
                               <div className="space-y-6">
                                   ...
                                   <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg">
                                       <div className="bg-blue-100 p-2 rounded-full mt-1"><BadgeDollarSign className="h-5 w-5 text-blue-600" /></div>
                                       <div>
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg">
                                       <div className="bg-purple-100 p-2 rounded-full mt-1"><Lightbulb className="h-5 w-5 text-purple-600" /></div>
                                       <div>
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg">
                                       <div className="bg-green-100 p-2 rounded-full mt-1"><Megaphone className="h-5 w-5 text-green-600" /></div>
                                       <div>
                                           <h4 className="font-semibold">Marketing Idea</h4>
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg">
                                       ...
                                       <div>
                                           <h4 className="font-semibold">Ideal Customer Persona</h4>
                                           <p className="text-sm text-muted-foreground">{analysis.idealCustomerPersona}</p>
                                       </div>
                                   </div>
                                     <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg">
                                       <div className="bg-red-100 p-2 rounded-full mt-1"><Camera className="h-5 w-5 text-red-600" /></div>
                                       <div>
                                           <h4 className="font-semibold">Photography Tips</h4>
                                           <p className="text-sm text-muted-foreground">{analysis.photographyTips}</p>
                                       </div>
                                   </div>
                                    <div className="p-4 bg-muted/50 rounded-lg">
                                       <h4 className="font-semibold flex items-center gap-2 mb-2"><Tags className="h-5 w-5"/> SEO Keywords</h4>
                                       <div className="flex flex-wrap gap-2">
                                            {analysis.seoKeywords.map(keyword => (
